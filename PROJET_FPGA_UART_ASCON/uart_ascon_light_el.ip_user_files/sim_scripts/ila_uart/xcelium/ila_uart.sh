...
#
# Script generated by Vivado on Mon Mar 24 15:51:47 +0100 2025
...
#
# Usage        : ila_uart.sh
#                ila_uart.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_uart.sh [-reset_run]
#                ila_uart.sh [-reset_log]
#                ila_uart.sh [-help]
#
...
#                script (type 'ila_uart.sh -help' for more information).
#
...
# script info
echo -e "ila_uart.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_uart.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../uart_ascon_light_el.gen/sources_1/ip/ila_uart/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../uart_ascon_light_el.gen/sources_1/ip/ila_uart/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_uart xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_uart -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_uart_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila_uart.sh [-step]\n\
Usage: ila_uart.sh [-lib_map_path]\n\
Usage: ila_uart.sh [-reset_run]\n\
Usage: ila_uart.sh [-reset_log]\n\
Usage: ila_uart.sh [-keep_index]\n\
